...
// Customized: 2011-01-11 by Wes Contreras
...
function WebTrends(){
	...
	this.downloadtypes="xls,doc,txt,csv,zip,mp3,mp4,mov,AVI,bin,bmp,BMP,cdx,cml,CSS,css,dat,db,exe,Exe,GIF,gif,gz,HTM,icb,jar,java,jpg,mol,pkg,png,ppt,psd,ris,rss,sgml,tab,TAB,tgz,ttf,TXT,utf,xml,rdf";
